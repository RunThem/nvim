...
M.on_attach = function(_, bufnr)
  ...
  utils.buf_map(bufnr, 'n', '<leader>wa',
                '<cmd>lua vim.lsp.buf.add_workspace_folder()<CR>')
  utils.buf_map(bufnr, 'n', '<leader>wr',
                '<cmd>lua vim.lsp.buf.remove_workspace_folder()<CR>')
  utils.buf_map(bufnr, 'n', '<leader>wl',
                '<cmd>lua print(vim.inspect(vim.lsp.buf.list_workspace_folders()))<CR>')
  utils.buf_map(bufnr, 'n', '<leader>D',
  ...
  utils.buf_map(bufnr, 'n', '<leader>ca',
                '<cmd>lua vim.lsp.buf.code_action()<CR>')
  utils.buf_map(bufnr, 'v', '<leader>ca',
                '<cmd>lua vim.lsp.buf.range_code_action()<CR>')
  utils.buf_map(bufnr, 'n', '<leader>e',
  ...
  utils.buf_map(bufnr, 'n', '<leader>q',
                '<cmd>lua vim.lsp.diagnostic.set_loclist()<CR>')
  utils.buf_map(bufnr, 'n', '<leader>so',
